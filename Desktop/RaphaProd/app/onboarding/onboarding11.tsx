...
export default function OnboardingScreen11() {
  ...
  const devotionalTimes = params.devotional_times as string;
  ...
  const [onboardingData, setOnboardingData] = useState({
    ...
    devotional_times: devotionalTimes ? JSON.parse(devotionalTimes) : {},
    additional_notes: '',
  });
  ...
  const handleContinue = () => {
    ...
    router.push({
      ...
      params: {
        ...
        devotional_times: JSON.stringify(finalOnboardingData.devotional_times),
            ...
            <View style={styles.answersContainer}>
              <View style={[styles.textInputContainer, { backgroundColor: colors.grey }]}>
                <TextInput
                  ...
                  placeholder="Share any additional thoughts, preferences, or concerns..."
