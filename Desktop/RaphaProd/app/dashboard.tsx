    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.statusSection}>
        ...
        {onboardingData && (
          <View style={[styles.statusCard, { backgroundColor: colors.grey }]}>
            <Text style={[styles.statusCardTitle, { color: colors.textPrimary }]}>
              Onboarding Data (From Local Storage)
            </Text>
      ...
      {/* Test Local Data Button */}
      <View style={styles.testSection}>
        <TouchableOpacity
          style={[styles.testButton, { borderColor: colors.textSecondary }]}
          onPress={async () => {
            const localProfile = await AuthService.getUserProfileLocally();
            console.log('🔍 Dashboard: Local profile data:', localProfile);
            alert(`Local profile data: ${JSON.stringify(localProfile, null, 2)}`);
          }}
          activeOpacity={0.8}
        >
