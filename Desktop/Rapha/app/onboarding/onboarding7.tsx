...
export default function OnboardingScreen7() {
  ...
  // Progress calculation - start from where onboarding6 finished (75% of 9 screens)
  const currentScreen = 7;
  const totalScreens = 9;
  const progressPercentage = (currentScreen / totalScreens) * 100;
  const startingProgress = 66.67; // onboarding6 finished at 66.67% of total 9 screens
