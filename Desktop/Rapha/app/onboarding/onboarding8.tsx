...
export default function OnboardingScreen8() {
  ...
  // Progress calculation - start from where onboarding7 finished (87.5% of 9 screens)
  const currentScreen = 8;
  const totalScreens = 9;
  const progressPercentage = (currentScreen / totalScreens) * 100;
  const startingProgress = 77.78; // onboarding7 finished at 77.78% of total 9 screens
