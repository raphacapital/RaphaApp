...
export default function OnboardingScreen6() {
  ...
  // Progress calculation - start from where onboarding5 finished (71.43% of 7 screens)
  const currentScreen = 6;
  const totalScreens = 7;
  const progressPercentage = (currentScreen / totalScreens) * 100;
  const startingProgress = 71.43; // onboarding5 finished at 71.43% of total 7 screens
  ...
  // Animate progress on mount - start from 83.33% and animate to 100%
  useEffect(() => {
    // Set initial value to 83.33%
